...
import com.securevote.securevotebackend.Dto.CandidateResponseDto;
...
public class CandidateController {
    ...
    public ResponseEntity<CandidateResponseDto> createCandidate(@RequestBody Candidate candidate){
        try {
            ...
            return ResponseEntity.status(HttpStatus.CREATED).body(new CandidateResponseDto(savedCandidate));
